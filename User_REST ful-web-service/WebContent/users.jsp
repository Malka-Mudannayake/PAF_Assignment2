				...
				<input id="userCode" name="userCode" type="text" class="form-control form-control-sm" placeholder="001">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                        	...
                        	02) UserName:
				<input id="userName" name="userName" type="text" class="form-control form-control-sm" placeholder="Username">
				<br>
                  ...
                  <div class="row">
                    ...
                    03) First Name:
				<input id="fName" name="fName" type="text" class="form-control form-control-sm" placeholder="First Name">
				<br>
